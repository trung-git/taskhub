...
const resources = {
  en: {
    translation: {
      ...
      th_key_hello: 'Hi',
      th_key_create_at: 'Create at',
      th_key_response_deadline: 'Response deadline',
      th_key_create_post: 'Create post',
      th_key_post_address_detail: 'Address detail',
      th_key_post_address_detail_place: 'Type address detail',
      th_key_post_photo_adding: 'Description with photos',
      th_key_post_drag: 'Drag & Drop or Select file',
      th_key_post_drop: 'Drop files here or click',
      th_key_post_browse: 'browse',
      th_key_post_thorough: 'thorough your machine',
      th_key_post_desc_place: 'Descripe about your task...',
      //
  ...
  vi: {
    translation: {
      ...
      th_key_hello: 'Xin Chào',
      th_key_create_at: 'Ngày tạo',
      th_key_response_deadline: 'Thời hạn phản hồi',
      th_key_create_post: 'Tạo một bài đăng',
      th_key_post_address_detail: 'Địa chỉ cụ thể',
      th_key_post_address_detail_place: 'Nhập địa chỉ cụ thể',
      th_key_post_photo_adding: 'Hình ảnh mô tả',
      th_key_post_drag: 'Kéo & Thả hoặc Chọn file',
      th_key_post_drop: 'Thả file vào đây hoặc nhấn',
      th_key_post_browse: 'vào đây',
      th_key_post_thorough: 'để chọn file',
      th_key_post_desc_place: 'Mô tả các yêu cầu của công việc...',
